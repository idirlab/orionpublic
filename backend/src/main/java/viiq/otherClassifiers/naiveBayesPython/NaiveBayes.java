package viiq.otherClassifiers.naiveBayesPython;
...
public class NaiveBayes {
	...
	private ArrayList<Integer> sendGet(String url, int[] features, int[] candidates) throws Exception {
		...
		//System.out.println("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"+t);
...
//		System.out.println("Response Code : " + responseCode);
	...
	public static void main(String[] args) throws Exception {
		...
		NaiveBayes rs = new NaiveBayes();
//		rs.learnModel();
//		System.out.println("Launched python web service");
		rs.sendGet("http://127.0.0.1:5000/rank_candidates", features, candidates);
	}
