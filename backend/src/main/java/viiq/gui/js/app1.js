...
function animatedHelp(){
  jQuery("#possible-actions").effect("highlight", "slow");
  if (nodes.length == 0 && links.length == 0) {
    jQuery("#active-help").empty();
    jQuery("#active-help").append('<li class="li-animation">Click on the canvas to add a new node.</li>');
  }else if (checkConnected(nodes, links)) {
    jQuery("#active-help").empty();
    jQuery("#active-help").append('<li class="li-animation">Add an edge between the newly added node and an existing node in the graph, by holding down the Shift key, clicking on one node and dragging the mouse pointer to the other.</li>');
    jQuery("#active-help").append('<li class="li-animation">Delete the unconnected node.</li>');
  }else if(suggestions && !suggestionPicked && subSuggestionsInProgressFlag == false && exampleReverseRoleFlag == false){
    jQuery("#active-help").empty();
    jQuery("#active-help").append('<li class="li-animation">Click on a grey node to add it and its incident edge to the query graph.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on the grey edge to select it and its corresponding grey node, or display the other occurrences of the grey edge, if any.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on the empty canvas to ignore the automatic suggestions and add a new node.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on Refresh Suggestions to get a new set of edge recommendations.</li>');
    jQuery("#active-help").append('<li class="li-animation">Ignore suggestions, close new node dialog box, view source type and destination type or edit node.</li>'); <!-- explain?-->
  }else if(suggestions && suggestionPicked && subSuggestionsInProgressFlag == false && exampleReverseRoleFlag == false){
    jQuery("#active-help").empty();
    jQuery("#active-help").append('<li class="li-animation">Click on other grey nodes to be included in the query graph.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on the grey edge to select it, or click on a grey edge to display the other occurrences of the grey edge.</li>'); <!-- explain, diff betw this and previous 2nd-->
    jQuery("#active-help").append('<li class="li-animation">Click on the empty canvas to add the selected nodes and edges to the query graph while ignoring the unselected grey nodes, and display new suggestions.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on selected nodes (in blue) to unselect them.</li>');
  }else if(suggestions && SugPickdPerGreyLinkCount == 0 && greyLinkPickdPerSubSuggestion == 0  && subSuggestionsInProgressFlag == true){
    jQuery("#active-help").empty();
    jQuery("#active-help").append('<li class="li-animation">Click on a grey node to add it and its incident edge to the query graph.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on a grey edge to add it to the query graph, or on a grey node to add the node and its incident edge to the query graph.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on the empty canvas to ignore the various unselected occurrences nodes and edges in grey, and go back to original set of suggestions.</li>');
  }else if(suggestions && (SugPickdPerGreyLinkCount > 0 || greyLinkPickdPerSubSuggestion > 0)  && subSuggestionsInProgressFlag == true){
    jQuery("#active-help").empty();
    jQuery("#active-help").append('<li class="li-animation">Click on other grey nodes to be included in the query graph.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on a grey edge to add it to the query graph, or on a grey node to add the node and its incident edge to the query graph.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on the empty canvas to display original unselected suggestions in grey and the selected suggestions in blue.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on selected nodes to unselect them. Click on selected edge (in blue) between two orange nodes to unselect it.</li>');
  } 
    ...
    jQuery("#active-help").empty();
    jQuery("#active-help").append('<li class="li-animation">Double click on an orange node to edit its value.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on an edge to view its source type, object type.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on Refresh Suggestions to get a new set of edge recommendations.</li>');
  }
  else if (exampleReverseRoleFlag == true && !suggestions && addEdgeButtonEdgeAdded == false){
    jQuery("#active-help").empty();
    jQuery("#active-help").append('<li class="li-animation">Click on Add Edge button to add other instances of the selected edge, connected to the nodes at the two ends of the selected edge.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on Reverse Role button to reverse the role of source and destination of the edge.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on the selected edge to remove souce type and destination type of edge.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on Refresh Suggestions to remove source type and destination type of edge and display new suggestions.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on empty canvas to remove source type and destination type of edge.</li>');
  }
  else if (suggestions && !suggestionPicked && exampleReverseRoleFlag == true && addEdgeButtonEdgeAdded == true){
    jQuery("#active-help").empty();
    jQuery("#active-help").append('<li class="li-animation">Click on a grey node to add it and its incident edge to the query graph.</li>');
    jQuery("#active-help").append('<li class="li-animation">Click on the empty canvas to ignore the automatic edge suggestions and add a new node.</li>');
  }
  else if (suggestions && suggestionPicked && exampleReverseRoleFlag == true && addEdgeButtonEdgeAdded == true){
    jQuery("#active-help").empty();
    jQuery("#active-help").append('<li class="li-animation">Click on other grey nodes to be included in the query graph.</li>');
