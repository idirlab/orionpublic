...
function getRequest(URL, container){
  ...
  jQuery.ajax({
      ...
      success: function(data) {
          ...
          // jQuery("#type-loader").html("");
          //
          //
          // jQuery("#entity-loader").html("");
      ...
      error: function(){
          ...
          // jQuery("#type-back").prop("disabled",true);
          // jQuery("#entity-next").prop("disabled",true);
          // jQuery("#entity-back").prop("disabled",true);
...
document.getElementById('entry_18415654').value = endTimeVar;
document.getElementById('entry_613028283').value = diff;
});
