...
- domain: holds all the domains retrieved from the GET request.
    ...
    {   startDateVar = new Date();
        ...
        if (!d3.event.shiftKey && allowNodeCreation) {
          ...
          if (suggestionPicked == false && linkSuggestionsFinalized == false && !disconnectedGraph)
             ...
             jQuery("#wrapNew").hide();
             //loadQuestion("http://localhost/ORION_WORK/abc.txt");
             jQuery("#useful-tips-div").toggleClass('active');
             jQuery("#wrap2").hide();
...
function collectDumpVariables (){
  ...
  document.getElementById("entry_814990847").value = getGraphStringUserStudy(partialGraph);
  document.getElementById("entry_316671573").value = getGraphStringUserStudy(rejectedGraph);
  document.getElementById("entry_1615171687").value = no_Of_Iterations;
