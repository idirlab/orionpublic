...
var firstUsefulTips = 1;
var refreshSelectedNode = 0;
var possibleActionsColor = 0;
var possibleActionsFlag = 0;
var usefulTipsFlag = 0;
var settingsFlag = 0;
var edgeTypesFlag = 0;
var possibleActionsBox = 0;
var displayFlag = 0;
...
function mousedown() {
  if (possibleActionsFlag == 1 || usefulTipsFlag == 1 || edgeTypesFlag == 1 || settingsFlag == 1){
      if (possibleActionsFlag == 1){
          possibleActionsFlag = 0;
          jQuery("#wrap1").toggleClass('active');
          jQuery("#possible-actions").toggleClass('active');
      ...
      if (usefulTipsFlag == 1){
          ...
          jQuery("#wrap2").toggleClass('active');
          jQuery("#useful-tips").toggleClass('active');
          if (firstUsefulTips == 1){
             if (possibleActionsFlag == 0){
                 possibleActionsFlag = 1;
             }
             else{
                 possibleActionsFlag = 0;
             } 
...
function createNewNode(){
  ...
  if (checkConnected(nodes, links) == true && disconnectedGraph != false){
      displayFlag = 1;
      DisplayAnimatedHelp();
  }
}
...
function DisplayAnimatedHelp(){
  if (possibleActionsBox == 0 && displayFlag == 1){ 
      displayFlag = 0;
      jQuery("#wrap1").toggleClass('active');
      jQuery("#possible-actions").toggleClass('active');
      if (possibleActionsFlag == 0){
...
jQuery("#possible-actions-div").on('click', function(){
  if (possibleActionsFlag == 0){
      CheckOtherWraps();
      possibleActionsFlag = 1;
  }
...
jQuery("#possible-actions").on('click', function(){
  if (possibleActionsFlag == 0){
      CheckOtherWraps();
      possibleActionsFlag = 1;
  }
...
jQuery("#wrap1-x-button").click(function(){
  if (possibleActionsFlag == 0){
      possibleActionsFlag = 1;
  }
  else{
...
$("#possible-actions-box").change( function(){
    if (possibleActionsBox == 0){
       possibleActionsBox = 1;}
    else{
       possibleActionsBox = 0;}
});
