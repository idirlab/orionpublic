...
jQuery("#type-back").click(function() {
    ...
    if(nodeToBeEdited == undefined) {
      getRequest("https://" + urlFull + "/orion_app/gettypes?domain=" + domainValue + "&windownum=" + windowNo + "&windowsize=" + typeWindowSize + "&keyword=" + keywordValue, typesList);
...
jQuery("#entity-back").click(function() {
    ...
    if(curTypeList.concat(curEndTypeList).length == 0) {
      getRequest("https://" + urlFull + "/orion_app/getentities?domain=" + domainValue + "&windownum=" + windowNo + "&windowsize=" + entityWindowSize + "&type=" + typeValue + "&keyword=" + keywordValue, entitiesList);
...
function addEntities() {
    ...
    getRequest("https://" + urlFull + "/orion_app/getentities?domain=" + domainValue + "&windownum=" + windowNo + "&windowsize=" + entityWindowSize + "&type=" + typeValue + "&keyword=" + keywordValue, entitiesThroughType);
    // if (entitiesList.length <= entityWindowSize) {
    //     jQuery("#entity-next").attr("disabled", true);
    // }
    // jQuery("#entity-options").empty();
...
function getAllDomains(domain) {
  getRequest("https://" + urlFull + "/orion_app/greeting", domain);
}
...
function getAllTypes(types) {
    ...
    var keywordValue = "";
    // var typeValue = -1;
    getRequest("https://" + urlFull + "/orion_app/gettypes?domain=" + domainValue + "&windownum=" + windowNo + "&windowsize=" + typeWindowSize + "&keyword=" + keywordValue, types);
...
function getAllEntities(entities) {
    ...
    getRequest("https://" + urlFull + "/orion_app/getentities?domain=" + domainValue + "&windownum=" + windowNo + "&windowsize=" + entityWindowSize + "&type=" + typeValue + "&keyword=" + keywordValue, entities);
